...
<div id="content-wrapper">
 ...
 //Main select and assign all main variables 
        ...
        String tableField[] = {"ip", "name", "model", "login", "password", "url", "id"};
...
<div class="mainHeadTop"><%=siteId%>: <%=className%></div>
    ...
    <form name="updateInfo" method="post" action="../updateInfo">
<div class="displayTableMain">
        <div class="displayRowMain">
            <div class="displayCellMain"><input class="mainHeadSub" readonly="" value="IP"></div><div class="displayCellMain"><input class="mainHeadSub" readonly="" value="Name"></div><div class="displayCellMain"><input class="mainHeadSub" readonly="" value="Model/OS"></div><div class="displayCellMain"><input class="mainHeadSub" readonly="" value="Login"></div><div class="displayCellMain"><input class="mainHeadSub" readonly="" value="Password"></div><div class="displayCellMain"><input class="mainHeadSub" readonly="" value="URL"></div><div class="displayCellMain"><input class="mainHeadSub" readonly="" value="id"></div>
        </div>
        ...
        <%  
            ...
            %><div class="displayRowMain"><%
                ...
                {
                     String display = classRecord[j];
                    if (j == 4) { display = encrypt.xor_decrypt(classRecord[j], "ic3t4l4ch4b1"); }
                    %><div class="displayCellMain"><input name="<%=tableField[j]%>" class="input" value="<%=display%>"></div><%
                }
                %></div><%
 ...
 <div style="padding-left: 20px;"><input type="submit" value="Update" class="submitButton"></div>
    </form>
